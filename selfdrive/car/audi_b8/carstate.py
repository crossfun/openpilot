...
#      ("GRA_ButtonTypeInfo", "GRA_ACC_01", 0),      # unknown related to stalk type
    ...
    checks = [
      ...
      ("ESP_19", 50),       # From J104 ABS/ESP controller
      ("ESP_05", 50),       # From J104 ABS/ESP controller
      ("ESP_21", 50),       # From J104 ABS/ESP controller
      ("Motor_20", 100),    # From J623 Engine control module
      ("TSK_01", 50),       # From J623 Engine control module
      ("TSK_06", 50),       # From J623 Engine control module
      ("ESP_02", 50),       # From J104 ABS/ESP controller
      ("GRA_ACC_01", 33),   # From J533 CAN gateway (via LIN from steering wheel controls)
      ("Gateway_72", 5),    # From J533 CAN gateway (aggregated data)
      ("Airbag_02", 5),     # From J234 Airbag control module
      ("Blinkmodi_02", 0),  # From J519 BCM (sent at 1Hz when no lights active, 50Hz when active)
      ("Einheiten_01", 20), # From J??? not known if gateway, cluster, or BCM
    ]
