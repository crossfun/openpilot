...
class CarController():
  def __init__(self, dbc_name, CP, VM):
    ...
    self.packer_pt = CANPacker(DBC_FILES.audi_b8)
    ...
    if CS.CP.pcmCruise:
      ...
      if CS.graMsgBusCounter != self.graMsgBusCounterPrev:
        ...
        if self.graButtonStatesToSend is not None:
          ...
          can_sends.append(volkswagencan.create_audi_b8_acc_buttons_control(self.packer_pt, ext_bus, self.graButtonStatesToSend, CS, idx))
